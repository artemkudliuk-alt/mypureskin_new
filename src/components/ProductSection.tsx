    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', width: '100%' }}>
          ...
          {/* LOWER BLOCK: Clean Row of 5 Separate Preview Tiles (STRICTLY BELOW UPPER BLOCK) */}
          <div
            style={{
              display: 'grid',
          ...
          >
            ...
            {/* Formulation & Recommendation Footer Bar — Exact 2-Column Alignment with Bullet List Above */}
            <div
              style={{
                marginTop: '0.85rem',
                paddingTop: '0.85rem',
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', borderTop: '1px solid #e4e4e7', paddingTop: '1rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
            <span style={{ fontSize: '13px', fontWeight: 700, color: '#090909' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid #e4e4e7', paddingTop: '1rem' }}>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
