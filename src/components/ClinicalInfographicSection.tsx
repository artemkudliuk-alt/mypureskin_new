  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', width: '100%' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1.5rem', paddingTop: '1.25rem', borderTop: '1px solid #f4f4f5' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '12px', color: '#a1a1aa', fontWeight: 600 }}>
        ...
        >
          {/* LEFT COLUMN: CENTERED/STRUCTURED TEXT + 2X2 STATS GRID (SHIFTED 50PX RIGHT FOR PERFECT BALANCE) */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', paddingLeft: '50px' }}>
            <div>
            ...
            {/* 2x2 Grid of 4 Stats with Floating Outline Icons & Count-Up Animation */}
            <div
              style={{
                display: 'grid',
                gridTemplateColumns: '1fr 1fr',
          ...
          {/* RIGHT COLUMN: HIGH-RES EXACT MYCOLLAGENREPAIR BOX & STICK IMAGE */}
        ...
        {/* ========================================================================= */}
        {/* 9 INGREDIENTS BORDERLESS 3-COLUMN (3X3 GRID) CENTERED SECTION (NO FRAMES)  */}
        {/* ========================================================================= */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', width: '100%' }}>
          ...
          {/* 9-Photo Grid (3 rows x 3 columns) in 21:9 Ultra-Wide Cards with Glossy Glass Sheen Animation */}
          <div
            style={{
              display: 'grid',
          ...
          >
            {INGREDIENTS_LIST.map((ing) => (
              ...
              >
                ...
                {/* Dosage Badge in Top Right Corner */}
                <div
                  style={{
                    position: 'absolute',
                    top: '12px',
                ...
                {/* White Text Overlay Content (Left Aligned) */}
                <div
                  style={{
                    position: 'relative',
                    zIndex: 2,
